...
void ConeArrayWithCovarianceDisplay::processMessage(driverless_msgs::msg::ConeDetectionStamped::ConstSharedPtr msg) {
...
void ConeArrayWithCovarianceDisplay::update(float wall_dt, float ros_dt) { marker_common_->update(wall_dt, ros_dt); }
...
PLUGINLIB_EXPORT_CLASS(eufs_rviz_plugins::displays::ConeArrayWithCovarianceDisplay, rviz_common::Display)
