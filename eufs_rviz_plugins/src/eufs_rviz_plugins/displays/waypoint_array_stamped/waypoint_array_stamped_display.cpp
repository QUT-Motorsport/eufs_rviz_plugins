...
WaypointArrayStampedDisplay::WaypointArrayStampedDisplay()
    ...
    color_property_ =
        new rviz_common::properties::ColorProperty("Color", QColor(100, 204, 153), "Color of waypoint array", this);
}
...
void WaypointArrayStampedDisplay::processMessage(eufs_msgs::msg::WaypointArrayStamped::ConstSharedPtr msg) {
...
void WaypointArrayStampedDisplay::update(float wall_dt, float ros_dt) { marker_common_->update(wall_dt, ros_dt); }
...
void WaypointArrayStampedDisplay::setMarkerArray(const eufs_msgs::msg::WaypointArrayStamped::ConstSharedPtr &msg) {
...
PLUGINLIB_EXPORT_CLASS(eufs_rviz_plugins::displays::WaypointArrayStampedDisplay, rviz_common::Display)
